...
__all__ = ['WordformTable', 'StemTable', 'MorphTable', 'InflectionTable', 'InflValTable', 'InflCatTable', 'LexemeTable', 'MorphemeTable', 'DerivationTable', 'DerivProcTable', 'WordformParts', 'FormParts', 'FormStems', 'StemParts', 'GlossTable', 'POSTable', 'TextTable', 'ExampleParts']
...
InflCatTable = jsonlib.load(cldf_path / "inflectionalcategories/InflCatTable-metadata.json")
...
DerivProcTable = jsonlib.load(cldf_path / "derivationalprocesses/DerivProcTable-metadata.json")
